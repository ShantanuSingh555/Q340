...
{
	LCM_DBG(" Yuvraj (abyss10) lcm_init...\n");
	SET_RESET_PIN(1);
	SET_RESET_PIN(0);
	MDELAY(50);
	SET_RESET_PIN(1);
...
static struct LCM_setting_table read_protect[] = {
       {0x00,1,{0x00}},
       {0xff,3,{0x80, 0x09, 0x01}},       	     	              {0x00,1,{0x80}},
       {0xff,2,{0x80, 0x09}},
       {0x00,1,{0xC6}},
       {0xB0,1,{0x03}},
};
...
{
	if(esdSwitch == 0){
		LCM_DBG("[Yuvraj (abyss10)] --esdSwitch == false\n");
		return 0;
	}
	unsigned int ret=0;
