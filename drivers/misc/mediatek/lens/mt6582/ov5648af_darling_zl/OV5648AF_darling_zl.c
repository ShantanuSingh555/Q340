...
static int OV5648AF_DARLING_ZL_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    char puSuspendCmd[2] = {(char)(0xEC), (char)(0xA3)};
    i4RetValue = i2c_master_send(g_pstOV5648AF_DARLING_ZL_I2Cclient, puSuspendCmd, 2);

    char puSuspendCmd1[2] = {(char)(0xA1), (char)(0x0D)};
    i4RetValue = i2c_master_send(g_pstOV5648AF_DARLING_ZL_I2Cclient, puSuspendCmd1, 2);

    char puSuspendCmd2[2] = {(char)(0xF2), (char)(0xE8)};
    i4RetValue = i2c_master_send(g_pstOV5648AF_DARLING_ZL_I2Cclient, puSuspendCmd2, 2);

    char puSuspendCmd3[2] = {(char)(0xDC), (char)(0x51)};
    i4RetValue = i2c_master_send(g_pstOV5648AF_DARLING_ZL_I2Cclient, puSuspendCmd3, 2);
    ...
    OV5648AF_DARLING_ZL_DB("[OV5648AF_DARLING_ZL_Open] OV5648AF_DARLING_ZL_Open - End\n");
